...
SEED_MARKET_ITEMS = [
    {
        "name": "Дуб Мудрости",
        "description": "Мощное дерево, символизирующее финансовую мудрость",
    ...
    {
        "name": "Сакура Удачи",
        "description": "Цветущая сакура приносит финансовую удачу",
    ...
    {
        "name": "Бамбук Роста",
        "description": "Быстрорастущий бамбук — символ постоянного роста",
    ...
    {
        "name": "Золотой горшок",
        "description": "Роскошный золотой горшок для вашего дерева",
        "cost": 50, "currency": "gem", "color": "#FFD700", "emoji": "🪴",
        "category": "decor", "is_new": False, "stages": [],
    },
    {
        "name": "Волшебный камень",
        "description": "Загадочный камень, притягивающий удачу",
    ...
    {
        "name": "Защита серии",
        "description": "Сохраняет вашу серию активности на 1 день",
